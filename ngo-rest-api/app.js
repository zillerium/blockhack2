...
app.get('/parcels/:parcelId', awaitHandler(async (req, res) => {
	logger.info('================ GET on Parcel by ID');
	logger.info('Parcel id : ' + req.params);
	let args = req.params;
	let fcn = "getParcelLocation";

    logger.info('##### GET on Parcel by username - username : ' + username);
	logger.info('##### GET on Parcel by username - userOrg : ' + orgName);
	logger.info('##### GET on Parcel by username - channelName : ' + channelName);
	logger.info('##### GET on Parcel by username - chaincodeName : ' + chaincodeName);
	logger.info('##### GET on Parcel by username - fcn : ' + fcn);
	logger.info('##### GET on Parcel by username - args : ' + JSON.stringify(args));
	logger.info('##### GET on Parcel by username - peers : ' + peers);
...
// POST Parcel
app.post('/parcels', awaitHandler(async (req, res) => {
	logger.info('================ POST on Parcel');
	var args = req.body;
	var fcn = "storeGeoLocation";

  logger.info('##### POST on Parcel - username : ' + username);
	logger.info('##### POST on Parcel - userOrg : ' + orgName);
	logger.info('##### POST on Parcel - channelName : ' + channelName);
	logger.info('##### POST on Parcel - chaincodeName : ' + chaincodeName);
	logger.info('##### POST on Parcel - fcn : ' + fcn);
	logger.info('##### POST on Parcel - args : ' + JSON.stringify(args));
	logger.info('##### POST on Parcel - peers : ' + peers);
